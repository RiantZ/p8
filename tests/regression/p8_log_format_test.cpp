...
TEST_F(c_log_format_test, int_d)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
...
TEST_F(c_log_format_test, int_hd)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT16);
...
TEST_F(c_log_format_test, int_hhd)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT8);
...
TEST_F(c_log_format_test, int_ld)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
#elif defined(GTX64)
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT64);
#else
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
#endif
}
...
TEST_F(c_log_format_test, int_jd)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INTMAX);
...
TEST_F(c_log_format_test, float_f)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_DOUBLE);
...
TEST_F(c_log_format_test, long_double_lf)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_LDOUBLE);
...
TEST_F(c_log_format_test, string_s)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_USTR8);
...
TEST_F(c_log_format_test, string_hs)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_STRA);
    EXPECT_EQ(mo_args[0].mu_size, 0u);
}
...
#if defined(G_OS_WINDOWS)
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_USTR16);
#else
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_USTR32);
#endif
    EXPECT_EQ(mo_args[0].mu_size, 0u);
}
...
TEST_F(c_log_format_test, char_c)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_CHAR);
...
#if defined(G_OS_WINDOWS)
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_CHAR16);
#else
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_CHAR32);
#endif
...
TEST_F(c_log_format_test, pointer_p)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_PVOID);
...
TEST_F(c_log_format_test, star_width_d)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[1].mu_type, P8_LOG_ARG_TYPE_INT32);
}
...
TEST_F(c_log_format_test, star_precision_f)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[1].mu_type, P8_LOG_ARG_TYPE_DOUBLE);
}
...
TEST_F(c_log_format_test, star_width_star_precision_f)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[1].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[2].mu_type, P8_LOG_ARG_TYPE_DOUBLE);
}
...
TEST_F(c_log_format_test, three_mixed)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[1].mu_type, P8_LOG_ARG_TYPE_USTR8);
    EXPECT_EQ(mo_args[2].mu_type, P8_LOG_ARG_TYPE_DOUBLE);
}
...
TEST_F(c_log_format_test, complex_log_line)
{
    ...
    EXPECT_EQ(mo_args[0].mu_type, P8_LOG_ARG_TYPE_INT32);
    EXPECT_EQ(mo_args[1].mu_type, P8_LOG_ARG_TYPE_USTR8);
    EXPECT_EQ(mo_args[2].mu_type, P8_LOG_ARG_TYPE_INT64);
    EXPECT_EQ(mo_args[3].mu_type, P8_LOG_ARG_TYPE_DOUBLE);
}
...
TEST_F(c_log_format_test, ten_ints)
{
    ...
    {
        EXPECT_EQ(mo_args[li].mu_type, P8_LOG_ARG_TYPE_INT32);
    }
}
